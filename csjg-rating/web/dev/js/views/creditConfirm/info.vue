...
<template>
  <div class="main-content credit-confirm">
    <div class="row-auto content-header">
      ...
      <span class="header-title">信用级别认定管理——查看</span>
      <div class="col txt-r">
    ...
    <form role="form" class="form-box-center">
      <div class="plr-11">
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">经营者档案:</span>
              {{params.operatorFiles | filter_map_key operatorFiless}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              <span class="mr-8">经营者档案和实际情况:</span>
              {{params.operatorFilesTruth | filter_map_key operatorFilesTruths}}
            </p>
          </div> 
        </div>
        <div class="secend-title control-group">
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              ...
              {{params.repayingRecords | filter_map_key isHas}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
        ...
        <div class="control-group">
          ...
          <div class="col">
            <p class="info-p">
              ...
              {{params.illegalOperation | filter_map_key isHas}}
            </p>
          </div>   
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">市场推出管理制度:</span>
              {{params.exitManagementSystem | filter_map_key isEstablish}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              <span class="mr-8">清退记录:</span>
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">市场内经销的驰名、著名商标商品登记档案:</span>
              {{params.registrationFiles | filter_map_key isEstablish}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col"></div>
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">市场信用建设工作开展:</span>
              {{params.creditWork | filter_map_key develop}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              <span class="mr-8">营造信用文化氛围:</span>
              {{params.culturalAtmosphere | filter_map_key isHas}}
            </p>
          </div>
        </div>
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">对场内经营者开展信用工作评比:</span>
              {{params.evaluationWork | filter_map_key isPart}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              <span class="mr-8">评比工作资料:</span>
              {{params.evaluationWorkFile | filter_map_key isHas}}
            </p>
          </div>
        </div>
        <div class="secend-title control-group">
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              <span class="mr-8">应对紧急突发事件的预案:</span>
              {{params.preparedness | filter_map_key isEstablish}}
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              <span class="mr-8">应急管理人员:</span>
              {{params.emergencyManagement}}
            </p>
          </div>
        </div>
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">{{params.punishmentCredit}}</p>
          </div> 
          <div class="col w-100"></div>
          <div class="col"></div>
        </div>
        ...
        <div class="control-group">
           <div class="col">
            <p class="info-p">{{params.publicFeedback}}</p>
          </div> 
          <div class="col w-100"></div>
          <div class="col"></div>
        </div>
        ...
        <div class="control-group">
           <div class="col">
            <p class="info-p">
              1、发放
              <span class="num-style">{{params.proposalContent}}</span>
              行政建议书
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col">
            <p class="info-p">
              2、发放
              <span class="num-style">{{params.rectificationNotice}}</span>
              限期整改通知书
            </p>
          </div>
        </div>
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              3、建议认定级别为
              <span class="level-style">{{params.categoryIdentification | filter_map_key creditRatings}}</span>
              级
            </p>
          </div> 
          <div class="col w-100"></div>
        ...
        <div class="row mb-50 mt-30">
          <div class="col txt-c">
            <button type="button" v-link="{name: 'credit-confirm-index'}" class="btn btn-back">返回</button>
          </div>
        </div>
      </div>
    </form>
