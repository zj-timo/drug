...
<template>
  <div class="main-content credit-confirm">
    <div class="row-auto content-header">
      ...
      <span class="header-title">信用巡查详情查看</span>
      <div class="col txt-r">
      ...
      <div class="plr-11">
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              现场检查，发现未照亮经营户
              <span class="num-style">{{params.unilluminatedOperation}}</span>户
            </p>
          </div>
          <div class="col w-100"></div>
          <div class="col"></div> 
        ...
        <div class="control-group">
          <div class="col">
            <p class="info-p">
              被监管部门查处假冒侵权等案件
              <span class="num-style">{{params.investigateInfringement}}</span>件
            </p>
          </div> 
          <div class="col w-100"></div>
          <div class="col"></div> 
    ...
    <div v-el:tap_wrap class="print-div">
      <print :industry-areas="industryAreas" :supervision-modes="supervisionModes" :params="params"></print>
    </div> 
  </div>
</template>
...
<script type="text/javascript">
  ...
  import print from './patrolPrint.vue'
