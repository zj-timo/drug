  ...
  <div class="main-content" v-el:main_content>
    ...
    <div class="plr-11">
      ...
      <div class="control-group">
        <div class="col">
          <div class="row">
            <span class="col w-100">监管方式:</span>
            <div class="col">
    ...
    data() {
     ...
     route:{
      data:function(transition){
        if (transition.from.name == "task-accept-info") {
          this.getStorage();
        }
      }
    },
    methods:{ 
       tempSearch(type) {
        ...
        return this.$promise((resolve, reject) => {
          ...
          this.params.userId = userInfo.account;
      ...
      clickInfo(pk) {
        this.setStorage();
        this.$router.go({name:'task-accept-info', params:{pk:pk}});
      }
    },
